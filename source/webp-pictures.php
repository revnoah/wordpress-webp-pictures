 ...
 * Description:       A plugin that replaces img tags with pictures tags and generates webp images
 * Version:           1.0.0
...
class WebpPictures
{
	 ...
	 *
	 * @param string $thumbnail_img HTML containing thumbnail image
	 * @return string
	 */
